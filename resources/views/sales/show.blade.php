...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="card print-area"
         style="max-width:900px; margin:0 auto; padding:40px 50px; font-family:'Segoe UI',sans-serif; color:#333;">

        {{-- Shop Header --}}
        <div class="text-center mb-4">

            <div style="font-weight:700; font-size:16px; color:#3a5fa0;">
                CMy Phone Shop
            </div>

            <div style="font-size:13px; color:#3a5fa0;">
                មានតំរូសសំឡឹ iPhone មកពីអាមេរិក
            </div>
        ...
        <div class="d-flex justify-content-between align-items-start mb-4">
            ...
            <div style="font-size:13px; color:#555; line-height:2;">
                ...
                <div>
                    ...
                    #44 មហាវិថីព្រះម៉ន់រំ សង្កាត់ស្រះចក ខណ្ឌដូនពេញ រាជធានីភ្នំពេញ
                </div>
            ...
            <div style="font-size:13px; color:#555; text-align:right; line-height:2;">
                ...
                <div>
                    Order Date:
                    <strong>{{ setToStringDateFormat($order->order_date) }}</strong>
                </div>
        ...
        <div class="mb-4 mt-3" style="font-size:13px;">
            ...
            <div style="color:#888;">
                {{ $order->customer?->phone ?? '000000000' }}
            </div>
        ...
        {{-- Title --}}
        <div class="text-center mb-4"
             style="font-size:15px; font-weight:600; letter-spacing:2px; color:#333;">
        ...
        <table class="table" style="font-size:13px;">
            ...
            <thead>
                ...
                <tr style="border-bottom:2px solid #ddd;">
                    ...
                    <th style="padding:10px 0;">IMAGE</th>

                    <th style="padding:10px 0;">COST</th>
        ...
        <div class="d-flex justify-content-between align-items-center mt-2">
            ...
            <div style="font-size:14px;">
                ...
                <strong style="color:#3a5fa0; font-size:15px;">
        ...
        <div style="font-size:12px; color:#888; margin-top:10px;">
            ...
            Note:
            {{ $order->note ?? 'សូមពិនិត្យទំនិញឲ្យបានត្រឹមត្រូវ ដាតច្បាប់ទំនិញមិនអាចប្ដូរបានទេ' }}
